...
/* 26E9A4 */ s32 it_8026E9A4(Item_GObj*, Vec*, Vec*, Vec*);
/* 26EA20 */ s32 it_8026EA20(Item_GObj*, Vec*, Vec*, Vec*, s32*, Vec*);
/* 26EA9C */ s32 it_8026EA9C(Item_GObj*, Vec*, Vec*, Vec*, s32, Vec*, s32);
/* 26EB18 */ void it_8026EB18(HSD_GObj*, s32, Vec*);
...
/* 26F8B4 */ bool it_8026F8B4(Item_GObj*, Vec*, Vec*, int);
...
/* 273500 */ void it_80273500(HSD_GObj*, Vec*);
/* 273748 */ void it_80273748(HSD_GObj*, Vec*, Vec*);
/* 273B50 */ void it_80273B50(HSD_GObj*, Vec*);
/* 274198 */ void it_80274198(HSD_GObj*, s32);
/* 2741F4 */ void it_802741F4(HSD_GObj*, s32);
/* 27429C */ void it_8027429C(HSD_GObj*, Vec*);
...
/* 27737C */ void it_8027737C(HSD_GObj* gobj, Vec* pos);
...
/* 27B5B0 */ Item_GObj* it_8027B5B0(s32, s32, HSD_JObj*, Vec*, s32);
