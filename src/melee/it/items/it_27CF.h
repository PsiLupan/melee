...
/* 2AE8A8 */ Item_GObj* it_802AE8A8(float, Fighter_GObj*, Vec*, Fighter_Part,
                                    ItemKind);
/* 2AEAB4 */ void it_802AEAB4(Item_GObj*);
/* 2B1DEC */ s32 it_802B1DEC(u32);
/* 2B1DF8 */ u32 it_802B1DF8(Item_GObj*, Vec*, Vec*, s32, s32, s32);
/* 2B1FC8 */ s32 it_802B1FC8(u32);
/* 2B1FE8 */ void it_802B1FE8(u32, Vec*);
/* 2B2560 */ HSD_GObj* it_802B2560(Item_GObj*, float, Vec*, long, u32);
/* 2B2674 */ void it_802B2674(Item_GObj*);
/* 2B26C0 */ void it_802B26C0(Item_GObj*);
/* 2B26E0 */ void it_802B26E0(Item_GObj*);
/* 2B338C */ void it_802B338C(Item_GObj*, Vec*, float facing_dir, u32);
/* 2B4AC8 */ void it_802B4AC8(Item_GObj* gobj, Vec*, float facing_dir,
                              float x);
/* 2B55C8 */ HSD_GObj* it_802B55C8(Item_GObj* owner, Vec*, s32, s32,
                                   float facing_dir);
/* 2B56E4 */ void it_802B56E4(Item_GObj*, Vec*, float, float, float);
/* 2B5974 */ void it_802B5974(Item_GObj*);
/* 2B62D0 */ void it_802B62D0(Item_GObj*, Vec* pos, bool, float facing_dir);
/* 2BAEEC */ void it_802BAEEC(Item_GObj*);
/* 2BAF0C */ void it_802BAF0C(Item_GObj*);
/* 2BB20C */ void it_802BB20C(Item_GObj*);
/* 2BB290 */ HSD_GObj* it_802BB290(Item_GObj* gobj, Vec* arg1,
                                   float facing_dir);
...
/* 2BCFC4 */ void it_802BCFC4(Item_GObj* gobj, float* arg1,
                              ...
                              float arg4);
/* 2BD158 */ void it_802BD158(Item_GObj* gobj, Vec*, int, float);
/* 2BD45C */ void it_802BD45C(Item_GObj* gobj);
/* 2BD4AC */ HSD_GObj* it_802BD4AC(Item_GObj*, Vec*, u8, s32, float);
...
/* 2BDE18 */ HSD_GObj* it_802BDE18(Item_GObj*, Vec*, Fighter_Part, enum_t,
                                   float);
...
/* 2BE214 */ void it_802BE214(Item_GObj* gobj, Vec* pos, enum_t,
                              float facing_dir);
...
/* 2BE9D8 */ HSD_GObj* it_802BE9D8(float, HSD_GObj*, Vec*, s32);
/* 2BFE5C */ void it_802BFE5C(Item_GObj*, Vec*, float);
/* 2BFEC4 */ void it_802BFEC4(void*);
/* 2C0010 */ void it_802C0010(Item_GObj*, void*);
/* 2C0510 */ void it_802C0510(Item_GObj*, Vec*, s32, s32, float facing_dir);
/* 2C0850 */ u32 it_802C0850(Item_GObj*, Vec*, u32, s32,
                             float facing_direction);
/* 2C0DBC */ void it_802C0DBC(u32 arg0);
/* 2C1590 */ Item_GObj* it_802C1590(Item_GObj*, Vec*, enum_t,
                                    float facing_dir);
/* 2C16F8 */ void it_802C16F8(Item_GObj*);
/* 2C17DC */ void it_802C17DC(Item_GObj*);
/* 2C3AF0 */ HSD_GObj* it_802C3AF0(Item_GObj*);
/* 2C3BAC */ HSD_GObj* it_802C3BAC(Item_GObj*, Vec*, float facing_dir, float);
/* 2C3D44 */ void it_802C3D44(Item_GObj*);
/* 2C49E0 */ void it_802C49E0(Item_GObj*);
/* 2C4A40 */ HSD_GObj* it_802C4A40(Item_GObj*, Vec*, float);
/* 2C5000 */ HSD_GObj* it_802C5000(Item_GObj*, Vec*, s32, s32, float);
/* 2C519C */ void it_802C519C(Item_GObj*, Vec*, s32, s32, float, float);
/* 2C53F0 */ void it_802C53F0(Item_GObj*, Vec*, float, float, float);
/* 2C573C */ void it_802C573C(Item_GObj*);
/* 2C61F4 */ HSD_GObj* it_802C61F4(Item_GObj*, Vec*, s32, float);
...
/* 2C720C */ HSD_GObj* it_802C720C(Item_GObj*, Vec*, s32, float);
...
/* 2C7774 */ HSD_GObj* it_802C7774(float, HSD_GObj*, Vec*, s32, u32);
/* 2C7A84 */ void it_802C7A84(Item_GObj*);
/* 2C7AD0 */ void it_802C7AD0(Item_GObj*);
/* 2C7AF0 */ void it_802C7AF0(Item_GObj*);
/* 2C8038 */ HSD_GObj* it_802C8038(Item_GObj*, Vec*, s32, s32, float, float);
/* 2C8158 */ void it_802C8158(Item_GObj*);
/* 2C81C8 */ void it_802C81C8(Item_GObj*);
/* 2C81E8 */ void it_802C81E8(Item_GObj*);
/* 2C837C */ HSD_GObj* it_802C837C(Item_GObj*, Vec*, enum_t, u32, float);
/* 2C8B28 */ HSD_GObj* it_802C8B28(Item_GObj*, Vec*, u32, float);
/* 2C8C34 */ void it_802C8C34(Item_GObj*);
/* 2E5F8C */ s32 it_802E5F8C(Item_GObj*, Vec*, s32, bool, float, float);
/* 2F0340 */ u32 it_802F0340(Item_GObj*, Vec*, Vec*, u32, u32, float);
/* 2F046C */ void it_802F046C(s32);
/* 2F0AE0 */ void it_802F0AE0(Item_GObj* fighter_gobj, Vec*, Vec*, enum_t,
